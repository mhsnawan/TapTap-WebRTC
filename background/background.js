...
function gotStream(stream) {
    ...
    if(options.mimeType === 'audio/wav') {
        ...
        console.log('going to call StereoAudioRecorder()');
        ...
        console.log('going to call MediaStreamRecorder()');
...
function stopScreenRecording() {
    ...
    recorder.stop(function onStopRecording(blob, ignoreGetSeekableBlob) {
        if(fixVideoSeekingIssues && recorder && !ignoreGetSeekableBlob) {
            console.log('Calling getSeekableBlob()');
...
function getUserConfigs() {
    ...
    chrome.storage.sync.get(null, function(items) {
        ...
        console.log('Calling captureDesktop()');
        captureDesktop();
    });
}
